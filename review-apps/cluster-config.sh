...
sed -i 's#$FI_SSL_KEY#'"$FI_SSL_KEY"'#; s#$FI_SSL_CERT#'"$FI_SSL_CERT"'#;  s#$K8_ENV_SECRET#'"$K8_ENV_SECRET"'#; s#$K8_AWS_SECRET#'"$K8_AWS_SECRET"'#; s#$FI_DEBUG#'"$(echo -n True | base64)"'#' review-apps/variables.yaml
