...
def _calc_cvss2_temporal(severity: Dict[str, float], basescore: Union[float, Decimal]) -> Decimal:
...
def _calc_cvss3_temporal(severity: Dict[str, float], basescore: Union[float, Decimal]) -> Decimal:
...
def calculate_cvss_temporal(
        severity: Dict[str, float], basescore: Union[float, Decimal], version: str) -> Decimal:
